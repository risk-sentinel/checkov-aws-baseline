...
#
# Rule:        CKV_AWS_101 (checkov 3.3.16)
...
control 'CKV_AWS_101' do
  ...
  desc 'check', <<~CHECK
    Checkov looks for: Ensure Neptune logging is enabled
  CHECK
  ...
  describe "CKV_AWS_101 — no deployed-asset reader for aws_neptune_cluster" do
