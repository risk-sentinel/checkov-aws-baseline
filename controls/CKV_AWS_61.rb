...
control 'CKV_AWS_61' do
  ...
  desc 'check', <<~CHECK
    Checkov looks for: Ensure AWS IAM policy does not allow assume role permission across all services
  CHECK
  ...
  describe "CKV_AWS_61 — no deployed-asset reader for aws_iam_role" do
