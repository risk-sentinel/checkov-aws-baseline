...
#
# Rule:        CKV_AWS_273 (checkov 3.3.16)
...
control 'CKV_AWS_273' do
  impact 0.0
  title 'Ensure access is controlled through SSO and not AWS IAM defined users'
  ...
  desc 'check', <<~CHECK
    Checkov looks for: Ensure access is controlled through SSO and not AWS IAM defined users
  CHECK
  ...
  describe "CKV_AWS_273 — no deployed-asset reader for aws_iam_user" do
