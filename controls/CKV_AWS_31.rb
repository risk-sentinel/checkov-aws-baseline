...
#
# Rule:        CKV_AWS_31 (checkov 3.3.16)
...
control 'CKV_AWS_31' do
  impact 0.0
  title 'Ensure all data stored in the ElastiCache Replication Group is securely encrypted at transit and has auth token'
  ...
  desc 'check', <<~CHECK
    Checkov looks for: Ensure all data stored in the ElastiCache Replication Group is securely encrypted at transit and has auth token
  CHECK
  ...
  describe "CKV_AWS_31 — no deployed-asset reader for aws_elasticache_replication_group" do
