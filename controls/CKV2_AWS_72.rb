...
#
# Rule:        CKV2_AWS_72 (checkov 3.3.16)
...
control 'CKV2_AWS_72' do
  impact 0.0
  title 'Ensure AWS CloudFront origin protocol policy enforces HTTPS-only'
  ...
  desc 'check', <<~CHECK
    Checkov looks for: Ensure AWS CloudFront origin protocol policy enforces HTTPS-only
  CHECK
  ...
  describe "CKV2_AWS_72 — no deployed-asset reader for aws_cloudfront_distribution" do
