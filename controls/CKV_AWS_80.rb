...
#
# Rule:        CKV_AWS_80 (checkov 3.3.16)
...
control 'CKV_AWS_80' do
  ...
  desc 'check', <<~CHECK
    Checkov looks for: Ensure MSK Cluster logging is enabled
  CHECK
  ...
  describe "CKV_AWS_80 — no deployed-asset reader for aws_msk_cluster" do
