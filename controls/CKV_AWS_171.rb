...
#
# Rule:        CKV_AWS_171 (checkov 3.3.16)
...
control 'CKV_AWS_171' do
  impact 0.0
  title 'Ensure EMR Cluster security configuration encryption is using SSE-KMS'
  ...
  desc 'check', <<~CHECK
    Checkov looks for: Ensure EMR Cluster security configuration encryption is using SSE-KMS
  CHECK
  ...
  describe "CKV_AWS_171 — no deployed-asset reader for aws_emr_security_configuration" do
