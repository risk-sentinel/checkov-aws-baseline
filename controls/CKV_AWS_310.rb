...
#
# Rule:        CKV_AWS_310 (checkov 3.3.16)
...
control 'CKV_AWS_310' do
  impact 0.0
  title 'Ensure CloudFront distributions should have origin failover configured'
  ...
  desc 'check', <<~CHECK
    Checkov looks for: Ensure CloudFront distributions should have origin failover configured
  CHECK
  ...
  describe "CKV_AWS_310 — no deployed-asset reader for aws_cloudfront_distribution" do
