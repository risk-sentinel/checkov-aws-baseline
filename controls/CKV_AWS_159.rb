...
#
# Rule:        CKV_AWS_159 (checkov 3.3.16)
...
control 'CKV_AWS_159' do
  ...
  desc 'check', <<~CHECK
    Checkov looks for: aws_athena_workgroup: configuration/[0]/result_configuration/[0]/encryption_configuration/[0]/encryption_option is CKV_ANY
  CHECK
  ...
  describe "CKV_AWS_159 — no deployed-asset reader for aws_athena_workgroup" do
