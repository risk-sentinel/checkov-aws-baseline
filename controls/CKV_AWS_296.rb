...
#
# Rule:        CKV_AWS_296 (checkov 3.3.16)
...
control 'CKV_AWS_296' do
  impact 0.0
  title 'Ensure DMS endpoint uses Customer Managed Key (CMK)'
  ...
  desc 'check', <<~CHECK
    Checkov looks for: Ensure DMS endpoint uses Customer Managed Key (CMK)
  CHECK
  ...
  describe "CKV_AWS_296 — no deployed-asset reader for aws_dms_endpoint" do
