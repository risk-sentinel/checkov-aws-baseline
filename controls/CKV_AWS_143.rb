...
#
# Rule:        CKV_AWS_143 (checkov 3.3.16)
...
control 'CKV_AWS_143' do
  ...
  desc 'check', <<~CHECK
    Checkov looks for: Ensure that S3 bucket has lock configuration enabled by default
  CHECK
  ...
  describe "CKV_AWS_143 — no deployed-asset reader for aws_s3_bucket" do
