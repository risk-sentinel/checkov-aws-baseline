...
#
# Rule:        CKV_AWS_114 (checkov 3.3.16)
...
control 'CKV_AWS_114' do
  impact 0.0
  title 'Ensure that EMR clusters with Kerberos have Kerberos Realm set'
  ...
  desc 'check', <<~CHECK
    Checkov looks for: Ensure that EMR clusters with Kerberos have Kerberos Realm set
  CHECK
  ...
  describe "CKV_AWS_114 — no deployed-asset reader for aws_emr_cluster" do
