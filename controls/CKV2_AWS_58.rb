...
#
# Rule:        CKV2_AWS_58 (checkov 3.3.16)
...
control 'CKV2_AWS_58' do
  impact 0.0
  title 'Ensure AWS Neptune cluster deletion protection is enabled'
  ...
  desc 'check', <<~CHECK
    Checkov looks for: Ensure AWS Neptune cluster deletion protection is enabled
  CHECK
  ...
  describe "CKV2_AWS_58 — no deployed-asset reader for aws_neptune_cluster" do
