...
control 'CKV_AWS_9' do
  ...
  desc 'rationale', <<~RATIONALE
    A policy that does not require lower-case characters permits a password
    drawn from a smaller alphabet, which shortens every offline cracking
    attempt against it.
  RATIONALE

  desc 'check', <<~CHECK
    Checkov looks for: aws_iam_account_password_policy: max_password_age is
    90
  CHECK
