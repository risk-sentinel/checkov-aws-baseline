...
#
# Rule:        CKV2_AWS_46 (checkov 3.3.16)
...
control 'CKV2_AWS_46' do
  impact 0.0
  title 'Ensure AWS CloudFront Distribution with S3 have Origin Access set to enabled'
  ...
  desc 'check', <<~CHECK
    Checkov looks for: Ensure AWS CloudFront Distribution with S3 have Origin Access set to enabled
  CHECK
  ...
  describe "CKV2_AWS_46 — no deployed-asset reader for aws_cloudfront_distribution" do
