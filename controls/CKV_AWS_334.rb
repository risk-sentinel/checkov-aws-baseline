...
#
# Rule:        CKV_AWS_334 (checkov 3.3.16)
...
control 'CKV_AWS_334' do
  impact 0.0
  title 'Ensure ECS containers should run as non-privileged'
  ...
  desc 'check', <<~CHECK
    Checkov looks for: Ensure ECS containers should run as non-privileged
  CHECK
  ...
  describe "CKV_AWS_334 — no deployed-asset reader for aws_ecs_task_definition" do
