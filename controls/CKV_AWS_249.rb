...
#
# Rule:        CKV_AWS_249 (checkov 3.3.16)
...
control 'CKV_AWS_249' do
  impact 0.0
  title 'Ensure that the Execution Role ARN and the Task Role ARN are different in ECS Task definitions'
  ...
  desc 'check', <<~CHECK
    Checkov looks for: Ensure that the Execution Role ARN and the Task Role ARN are different in ECS Task definitions
  CHECK
  ...
  describe "CKV_AWS_249 — no deployed-asset reader for aws_ecs_task_definition" do
