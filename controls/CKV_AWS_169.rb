...
control 'CKV_AWS_169' do
  ...
  desc 'check', <<~CHECK
    Checkov looks for: Ensure SNS topic policy is not public by only allowing specific services or principals to access it
  CHECK
  ...
  describe "CKV_AWS_169 — no deployed-asset reader for aws_sns_topic_policy" do
