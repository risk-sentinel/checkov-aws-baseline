...
#
# Rule:        CKV_AWS_48 (checkov 3.3.16)
...
exempt       = (input('exempt_assets') || {})['CKV_AWS_48'] || []

control 'CKV_AWS_48' do
  title 'Ensure MQ Broker logging is enabled'
  ...
  desc 'rationale', <<~RATIONALE
    Ensure MQ Broker logging is enabled. Anchors derived from the check's
    logging category, not reviewed control by control.
  RATIONALE

  desc 'check', <<~CHECK
    Checkov looks for: aws_mq_broker: logs/[0]/general is True
  CHECK
