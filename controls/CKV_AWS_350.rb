...
#
# Rule:        CKV_AWS_350 (checkov 3.3.16)
...
control 'CKV_AWS_350' do
  impact 0.0
  title 'Ensure EMR Cluster security configuration encrypts EBS disks'
  ...
  desc 'check', <<~CHECK
    Checkov looks for: Ensure EMR Cluster security configuration encrypts EBS disks
  CHECK
  ...
  describe "CKV_AWS_350 — no deployed-asset reader for aws_emr_security_configuration" do
