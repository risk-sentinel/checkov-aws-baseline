...
control 'CKV_AWS_12' do
  ...
  desc 'rationale', <<~RATIONALE
    A policy without a digit requirement permits all-alphabetic passwords,
    which are the first thing a wordlist attack tries.
  RATIONALE

  desc 'check', <<~CHECK
    Checkov looks for: aws_iam_account_password_policy: require_numbers is
    True
  CHECK
