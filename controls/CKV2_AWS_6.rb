...
#
# Rule:        CKV2_AWS_6 (checkov 3.3.16)
...
exempt       = (input('exempt_assets') || {})['CKV2_AWS_6'] || []

control 'CKV2_AWS_6' do
  ...
  desc 'rationale', <<~RATIONALE
    The public access block is the account-independent backstop: without it,
    a future ACL or policy change can make the bucket public with no further
    review.
  RATIONALE

  desc 'check', <<~CHECK
    Checkov looks for: Ensure that S3 bucket has a Public Access block
  CHECK
  ...
  tag checkov_id:            'CKV2_AWS_6'
  tag checkov_category:      'NETWORKING'
  tag checkov_version:       '3.3.16'
  tag checkov_kind:          'graph'
  tag tf_resources:          %w[aws_s3_bucket aws_s3_bucket_public_access_block]
