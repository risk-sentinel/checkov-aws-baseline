...
#
# Rule:        CKV_AWS_38 (checkov 3.3.16)
...
control 'CKV_AWS_38' do
  ...
  desc 'check', <<~CHECK
    Checkov looks for: Ensure Amazon EKS public endpoint not accessible to 0.0.0.0/0
  CHECK
  ...
  describe "CKV_AWS_38 — no deployed-asset reader for aws_eks_cluster" do
