...
#
# Rule:        CKV_AWS_97 (checkov 3.3.16)
...
control 'CKV_AWS_97' do
  ...
  desc 'check', <<~CHECK
    Checkov looks for: Ensure Encryption in transit is enabled for EFS volumes in ECS Task definitions
  CHECK
  ...
  describe "CKV_AWS_97 — no deployed-asset reader for aws_ecs_task_definition" do
