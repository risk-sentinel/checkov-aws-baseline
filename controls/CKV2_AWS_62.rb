...
#
# Rule:        CKV2_AWS_62 (checkov 3.3.16)
...
control 'CKV2_AWS_62' do
  ...
  desc 'check', <<~CHECK
    Checkov looks for: Ensure S3 buckets should have event notifications enabled
  CHECK
  ...
  describe "CKV2_AWS_62 — no deployed-asset reader for aws_s3_bucket" do
